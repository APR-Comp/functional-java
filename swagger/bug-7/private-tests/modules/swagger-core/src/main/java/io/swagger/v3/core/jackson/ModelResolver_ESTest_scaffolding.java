...
public class ModelResolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.swagger.v3.core.jackson.ModelResolver"; 
  ...
  public static void setSystemProperties() {
    ...
    java.lang.System.setProperties((java.util.Properties) defaultProperties.clone()); 
    java.lang.System.setProperty("user.dir", "/home/crhf/projects/apr-comp/experiment/functional-java-private/swagger/bug-7/src/modules/swagger-core"); 
    java.lang.System.setProperty("java.io.tmpdir", "/tmp"); 
  }

  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ModelResolver_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "io.swagger.v3.core.util.OptionalUtils",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonAutoDetect", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonInclude", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonSetter", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.annotation.JsonView", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.type.TypeReference", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.deser.BeanDeserializerModifier", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.deser.DeserializationProblemHandler", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.introspect.POJOPropertiesCollector", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.ser.BeanSerializerModifier", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.v3.oas.annotations.ExternalDocumentation", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.v3.oas.annotations.media.ArraySchema", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.swagger.v3.oas.annotations.media.Schema", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.net.URLStreamHandler", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.xml.bind.annotation.XmlAccessorType", false, ModelResolver_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ModelResolver_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "io.swagger.v3.core.jackson.AbstractModelConverter",
      "io.swagger.v3.core.jackson.ModelResolver",
      "io.swagger.v3.core.jackson.ModelResolver$GeneratorWrapper",
      "io.swagger.v3.core.jackson.ModelResolver$GeneratorWrapper$Base",
      "io.swagger.v3.core.jackson.ModelResolver$GeneratorWrapper$PropertyGeneratorWrapper",
      "io.swagger.v3.core.jackson.ModelResolver$GeneratorWrapper$IntGeneratorWrapper",
      "io.swagger.v3.core.jackson.ModelResolver$GeneratorWrapper$UUIDGeneratorWrapper",
      "io.swagger.v3.core.jackson.ModelResolver$GeneratorWrapper$NoneGeneratorWrapper",
      ...
      "io.swagger.v3.core.util.OptionalUtils",
      "com.fasterxml.jackson.annotation.JsonProperty$Access",
      "io.swagger.v3.core.jackson.ModelResolver$1",
      "io.swagger.v3.core.jackson.TypeNameResolver$Options",
      "com.fasterxml.jackson.annotation.JsonTypeInfo$As",
      "com.fasterxml.jackson.annotation.JsonTypeInfo$Id",
      "com.fasterxml.jackson.core.TokenStreamFactory",
      ...
      "io.swagger.v3.oas.models.media.MapSchema",
      "io.swagger.v3.core.jackson.PackageVersion",
      "com.fasterxml.jackson.databind.node.TextNode",
      "com.fasterxml.jackson.databind.node.FloatNode",
      "com.fasterxml.jackson.core.json.async.NonBlockingJsonParserBase",
      "com.fasterxml.jackson.core.json.async.NonBlockingJsonParser",
